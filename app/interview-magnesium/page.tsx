...
export default function InterviewMagnesiumPage() {
  ...
  const onMessage = useCallback((message: unknown) => {
    ...
    setTranscript((prev) => [...prev, { role: m.source, text: m.message, timestamp: now }]);
  ...
  return (
    <div className="min-h-screen page-gradient relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-4">
              ...
              <div>
                <h1 className="text-xl font-bold text-gray-900">Verkaufsgespräch</h1>
                <div className="flex items-center space-x-2 mt-0.5">
                  <p className="text-sm text-gray-600 font-medium">
                    Magnesiumcitrat 130: Beratung & Verkauf
                  </p>
                  <Badge
                    variant="outline"
      ...
      <main className="relative z-10 max-w-7xl w-full mx-auto px-4 sm:px-6 lg:px-8 py-8">
            ...
            <DialogHeader>
              ...
              <DialogDescription>
                <div className="space-y-3 pt-3 text-gray-700 text-base">
                  <p>
                    Ein Kunde betritt die Apotheke. Du berätst ihn zu{" "}
                    <strong>Magnesiumcitrat 130</strong> und überzeugst ihn
                    von den Vorteilen des Produkts.
                  </p>
                  <div className="bg-brand/10 p-3 rounded-lg text-sm text-gray-800 border border-brand/20">
                    <strong>Schwerpunkte:</strong>
                    <ul className="mt-1 space-y-0.5">
                      <li>- Kundentyp erkennen und gezielt beraten</li>
                      <li>- Vorteile der Citratform erklären</li>
                      <li>- Einwände professionell behandeln</li>
                      <li>- Zusatzverkäufe ansprechen</li>
                    </ul>
                  </div>

                  <div className="bg-amber-50 p-3 rounded-lg text-sm text-amber-800 border border-amber-200">
                    <strong>Hinweis:</strong> Bitte nutze die Sprachberatung in einer ruhigen Umgebung.
                  </div>
                </div>
              </DialogDescription>
            </DialogHeader>
        ...
        {/* Main layout: ConvAI + Transcript (no consultation tracker) */}
        <div className={isConnected
          ...
          {/* Right: Transcript only (no consultation tracker) */}
          {isConnected && (
